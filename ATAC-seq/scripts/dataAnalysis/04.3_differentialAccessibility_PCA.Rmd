...
saveRDS(stage.perSomite.sva, paste0(dir, "ATAC-seq/results/04_diffAccessibility_stages_perSomite_sva.Rds"))
...
Nonetheless, the changing loci are highly consistent between the somites.

```{r overlap}
s1 <- stage.perSomite.sva[["somiteI"]][stage.perSomite.sva[["somiteI"]]$FDR < 0.05,]
s2 <- stage.perSomite.sva[["somiteII"]][stage.perSomite.sva[["somiteII"]]$FDR < 0.05,]
s3 <- stage.perSomite.sva[["somiteIII"]][stage.perSomite.sva[["somiteIII"]]$FDR < 0.05,]
```
...
saveRDS(filtered.data, paste0(dir, "ATAC-seq/results/04_diffAccessibility_stages_average_sva.Rds"))
```
